	...
	<div class="content">
		<ul>
			...
			<div id="content">
				<div class="post">
					<h2 class="title">
						Інформація про <c:out value="${pz.name}"></c:out>
					</h2>					
					<div class="entry">		
					<center>			
					<table border=1 class="tableHoriz">					
								<tr>								    
									...
									<td class="simple">
										<c:out value="${pz.name}"></c:out>
									</td>
									<th rowspan=12><img src="${pz.photo}" /></th>
								</tr>
								<tr>
									<td class="header">
										Виробник
									...
									<td class="simple">
										<c:out value="${pz.manufacturer}"></c:out>
									</td>
								</tr>
								<tr>
									<td class="header">
